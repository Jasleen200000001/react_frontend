...
function Footer() {
  return (
    <footer>
      <div className="flex pt-10 justify-between px-10 ">
        <div className='w-[250px]'>
          <h1 className="font-[FoundersGrotesk] uppercase text-[10rem] leading-[10rem]">
            eye-opening
          </h1>
        </div>
        <div className="">
          ...
          <div className="font-neue-montreal text-[1.6rem] py-10 my-9 grid grid-cols-2 gap-30 ">
            <div>
      ...
      <div className="flex justify-between items-center text-gray-600 p-10">
        ...
        <div className="text-[1.6rem] text-gray-400">© ochi design 2024.</div>
        <div className="text-[1.6rem] text-gray-400">Website by Jasleen Kaur</div>
      </div>
    </footer>
  );
}
